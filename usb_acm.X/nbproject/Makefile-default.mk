...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/usb_acm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=usb/usb_events.c usb/usb_serial.c usb/usb_basic.c usb/usb.c configure_bits.c debug.c leds.c main.c state_machine.c terminal.c timer2.c uart.c init.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/usb/usb_events.o ${OBJECTDIR}/usb/usb_serial.o ${OBJECTDIR}/usb/usb_basic.o ${OBJECTDIR}/usb/usb.o ${OBJECTDIR}/configure_bits.o ${OBJECTDIR}/debug.o ${OBJECTDIR}/leds.o ${OBJECTDIR}/main.o ${OBJECTDIR}/state_machine.o ${OBJECTDIR}/terminal.o ${OBJECTDIR}/timer2.o ${OBJECTDIR}/uart.o ${OBJECTDIR}/init.o
POSSIBLE_DEPFILES=${OBJECTDIR}/usb/usb_events.o.d ${OBJECTDIR}/usb/usb_serial.o.d ${OBJECTDIR}/usb/usb_basic.o.d ${OBJECTDIR}/usb/usb.o.d ${OBJECTDIR}/configure_bits.o.d ${OBJECTDIR}/debug.o.d ${OBJECTDIR}/leds.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/state_machine.o.d ${OBJECTDIR}/terminal.o.d ${OBJECTDIR}/timer2.o.d ${OBJECTDIR}/uart.o.d ${OBJECTDIR}/init.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/usb/usb_events.o ${OBJECTDIR}/usb/usb_serial.o ${OBJECTDIR}/usb/usb_basic.o ${OBJECTDIR}/usb/usb.o ${OBJECTDIR}/configure_bits.o ${OBJECTDIR}/debug.o ${OBJECTDIR}/leds.o ${OBJECTDIR}/main.o ${OBJECTDIR}/state_machine.o ${OBJECTDIR}/terminal.o ${OBJECTDIR}/timer2.o ${OBJECTDIR}/uart.o ${OBJECTDIR}/init.o

# Source Files
SOURCEFILES=usb/usb_events.c usb/usb_serial.c usb/usb_basic.c usb/usb.c configure_bits.c debug.c leds.c main.c state_machine.c terminal.c timer2.c uart.c init.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/usb_acm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/usb/usb.o: usb/usb.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/usb/usb.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/usb/usb.o.d" -o ${OBJECTDIR}/usb/usb.o usb/usb.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/usb/usb.o: usb/usb.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/usb/usb.o.d 
	@${RM} ${OBJECTDIR}/usb/usb.o 
	@${FIXDEPS} "${OBJECTDIR}/usb/usb.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/usb/usb.o.d" -o ${OBJECTDIR}/usb/usb.o usb/usb.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/usb_acm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/usb_acm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x37F   -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_PK3=1,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/usb_acm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/usb_acm.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	${MP_CC_DIR}/xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/usb_acm.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
