...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/usb_ecm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=usb/usb.c usb/usb_events.c configure_bits.c debug.c init.c leds.c main.c state_machine.c terminal.c timer2.c uart.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/usb/usb.o ${OBJECTDIR}/usb/usb_events.o ${OBJECTDIR}/configure_bits.o ${OBJECTDIR}/debug.o ${OBJECTDIR}/init.o ${OBJECTDIR}/leds.o ${OBJECTDIR}/main.o ${OBJECTDIR}/state_machine.o ${OBJECTDIR}/terminal.o ${OBJECTDIR}/timer2.o ${OBJECTDIR}/uart.o
POSSIBLE_DEPFILES=${OBJECTDIR}/usb/usb.o.d ${OBJECTDIR}/usb/usb_events.o.d ${OBJECTDIR}/configure_bits.o.d ${OBJECTDIR}/debug.o.d ${OBJECTDIR}/init.o.d ${OBJECTDIR}/leds.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/state_machine.o.d ${OBJECTDIR}/terminal.o.d ${OBJECTDIR}/timer2.o.d ${OBJECTDIR}/uart.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/usb/usb.o ${OBJECTDIR}/usb/usb_events.o ${OBJECTDIR}/configure_bits.o ${OBJECTDIR}/debug.o ${OBJECTDIR}/init.o ${OBJECTDIR}/leds.o ${OBJECTDIR}/main.o ${OBJECTDIR}/state_machine.o ${OBJECTDIR}/terminal.o ${OBJECTDIR}/timer2.o ${OBJECTDIR}/uart.o

# Source Files
SOURCEFILES=usb/usb.c usb/usb_events.c configure_bits.c debug.c init.c leds.c main.c state_machine.c terminal.c timer2.c uart.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/usb_ecm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/usb_ecm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/usb_ecm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x37F   -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_PK3=1,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/usb_ecm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/usb_ecm.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	${MP_CC_DIR}/xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/usb_ecm.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
